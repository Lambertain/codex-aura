#!/usr/bin/env python3
"""Benchmark script to measure performance on real repositories."""
...
def benchmark_repo(repo_path: Path):
...
def main():
    """Main function."""
    if len(sys.argv) != 2:
        print("Usage: python examples/benchmark.py <repo_path>")
        print("Example: python examples/benchmark.py /path/to/large/repo")
        sys.exit(1)
